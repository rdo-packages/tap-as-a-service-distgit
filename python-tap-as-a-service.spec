...
cp etc/taas_plugin.ini.sample %{buildroot}/%{_sysconfdir}/neutron/taas_plugin.ini
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/tap-as-a-service/commit/257e89ca9fe02e784cd85066b3380318f28892bc
